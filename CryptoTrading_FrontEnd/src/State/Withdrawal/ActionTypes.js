export const WITHDRAWAL_REQUEST = "WITHDRWAL_REQUEST";
export const WITHDRAWAL_SUCCESS = "WITHDRWAL_SUCCESS";
export const WITHDRAWAL_FAILURE = "WITHDRWAL_FAILURE";

export const WITHDRAWAL_PROCEED_REQUEST = "WITHDRWAL_PROCEED_REQUEST";
export const WITHDRAWAL_PROCEED_SUCCESS = "WITHDRWAL_PROCEED_SUCCESS";
export const WITHDRAWAL_PROCEED_FAILURE = "WITHDRWAL_PROCEED_FAILURE";
